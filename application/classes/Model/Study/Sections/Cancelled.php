...
class Model_Study_Sections_Cancelled extends ORM {

    protected $_table_name = 'study_sections_cancelled';
    protected $_belongs_to = array(
        'Section' => array('model' => 'Study_Sections', 'foreign_key' => 'section'),
        'Section_Date' => array('model' => 'Study_Sections_Dates', 'foreign_key' => 'cancelled_appointment'),
