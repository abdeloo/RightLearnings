...
class Model_Study_Sections_Comments_Interactions extends ORM {

    protected $_table_name = 'study_sections_comments_interactions';
    protected $_belongs_to = array(
        'Comment' => array('model' => 'Study_Sections_Comments', 'foreign_key' => 'comment'),
