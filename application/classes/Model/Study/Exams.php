...
class Model_Study_Exams extends ORM {

    protected $_table_name = 'study_exams';
    protected $_belongs_to = array(        
    );
    protected $_has_many = array(
        'CourseExams' => array('model' => 'Study_Courses_Exams', 'foreign_key' => 'exam'),
        );
