...
class Model_Study_Departments extends ORM {

    protected $_table_name = 'study_departments';
    protected $_belongs_to = array(
        'College' => array('model' => 'Study_Colleges', 'foreign_key' => 'college'),
    );
    protected $_has_many = array(
            'Financials_Fees_Courses' => array('model' => 'Financials_Fees_Courses', 'foreign_key' => 'department'),
    );
