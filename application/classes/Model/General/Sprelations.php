...
class Model_General_Sprelations extends ORM {

    protected $_table_name = 'general_student_parent_relation';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Students_Applications' => array('model' => 'Students_Applications', 'foreign_key' => 'g_relation'),
    );
