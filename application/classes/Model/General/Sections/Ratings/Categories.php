...
class Model_General_Sections_Ratings_Categories extends ORM {

    protected $_table_name = 'study_sections_ratings_categories';
    protected $_belongs_to = array(
        'Createdby' => array('model' => 'User', 'foreign_key' => 'Created_by'),
    );
    protected $_has_many = array(
        'Category' => array('model' => 'Study_Sections_Ratings', 'foreign_key' => 'category'),
    );
