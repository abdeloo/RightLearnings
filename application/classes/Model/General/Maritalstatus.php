...
class Model_General_Maritalstatus extends ORM {

    protected $_table_name = 'general_marital_status';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Employments_Applications' => array('model' => 'Hr_Employment_Applications', 'foreign_key' => 'marital_status'),
    );
