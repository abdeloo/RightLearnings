...
class Model_General_Hr_Employee_Types extends ORM {

    protected $_table_name = 'general_hr_employee_types';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Employments_Applications' => array('model' => 'Hr_Employment_Applications', 'foreign_key' => 'employee_type'),
    );
