...
class Model_General_Hr_Positions extends ORM {

    protected $_table_name = 'general_hr_positions';
    protected $_belongs_to = array(
        'Department' => array('model' => 'General_Hr_Departments', 'foreign_key' => 'department'),
    );
    protected $_has_many = array(
        'Employments_Applications' => array('model' => 'Hr_Employment_Applications', 'foreign_key' => 'hr_position'),
        'Directors' => array('model' => 'General_Hr_Departments', 'foreign_key' => 'director'),
        'Deputys_Directors' => array('model' => 'General_Hr_Departments', 'foreign_key' => 'deputy_director'),
    );
