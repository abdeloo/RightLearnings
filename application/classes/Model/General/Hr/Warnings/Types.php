...
class Model_General_Hr_Warnings_Types extends ORM {

    protected $_table_name = 'general_hr_warnings_types';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Hr_Fines' => array('model' => 'Hr_Fineswarnings', 'foreign_key' => 'warning_type'),
    );
