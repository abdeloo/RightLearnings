...
class Model_General_Hr_Rewards_Types extends ORM {

    protected $_table_name = 'general_hr_rewards_types';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Hr_Reward' => array('model' => 'Hr_Rewards', 'foreign_key' => 'reward_type'),
    );
