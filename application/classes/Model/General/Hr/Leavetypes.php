...
class Model_General_Hr_Leavetypes extends ORM {

    protected $_table_name = 'general_hr_leavetypes';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Leave_Requests' => array('model' => 'Hr_Leaverequest', 'foreign_key' => 'leave_type'),
    );
