...
class Model_General_Hscertypes extends ORM {

    protected $_table_name = 'general_hs_certificate_type';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Students_Applications' => array('model' => 'Students_Applications', 'foreign_key' => 'hs_Certificate_Type',),
    );
