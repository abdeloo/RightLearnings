...
class Model_General_Students_Study_State extends ORM {

    protected $_table_name = 'students_study_state';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Student_Apps' => array('model' => 'Students_Applications', 'foreign_key' => 'S_Type',),
    );
