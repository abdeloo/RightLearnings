...
class Model_General_Elearning_Students_Participates extends ORM {

    protected $_table_name = 'general_elearning_participates';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Student_Participates' => array('model' => 'Students_Participates', 'foreign_key' => 'participate_type'),
    );
