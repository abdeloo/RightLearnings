...
class Model_General_Elearning_Students_Infractions extends ORM {

    protected $_table_name = 'general_elearning_infractions';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Student_Infractions' => array('model' => 'Students_Infractions', 'foreign_key' => 'infraction_type'),
    );
