...
class Model_General_Companytypes extends ORM {

    protected $_table_name = 'general_company_types';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'DemoRequests' => array('model' => 'Demo_Requests', 'foreign_key' => 'company_type'),
    );
