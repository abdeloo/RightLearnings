...
class Model_General_Genders extends ORM {

    protected $_table_name = 'general_genders';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Students_Applications' => array('model' => 'Students_Applications', 'foreign_key' => 'Gender'),
        'Employments_Applications' => array('model' => 'Hr_Employment_Applications', 'foreign_key' => 'gender'),
        'Study_Sections' => array('model' => 'Study_Sections', 'foreign_key' => 'gender'),
    );
