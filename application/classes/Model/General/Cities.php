...
class Model_General_Cities extends ORM {

    protected $_table_name = 'general_cities';
    protected $_belongs_to = array(
        'Country' => array('model' => 'General_Countries', 'foreign_key' => 'country_id',),
    );
    protected $_has_many = array(
        'Students_Applications' => array('model' => 'Students_Applications', 'foreign_key' => 'hs_City',),
