...
class Model_General_Religions extends ORM {

    protected $_table_name = 'general_religions';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Employments_Applications' => array('model' => 'Hr_Employment_Applications', 'foreign_key' => 'religion'),
    );
