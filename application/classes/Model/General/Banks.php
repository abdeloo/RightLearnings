...
class Model_General_Banks extends ORM {

    protected $_table_name = 'general_banks';
    protected $_belongs_to = array(
    );
    protected $_has_many = array(
        'Employments_Applications' => array('model' => 'Hr_Employment_Applications', 'foreign_key' => 'bank'),
        'Accounting_Accounts' => array('model' => 'Accounting_Accounts', 'foreign_key' => 'bank'),
    );
