...
class Model_General_Payment_Methods extends ORM {

    protected $_table_name = 'general_payment_methods';
    
    protected $_has_many = array(
        'PaymentAccounts' => array('model' => 'Payment_Accounts', 'foreign_key' => 'payment_method_id',),
    );
