                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-3 col-3">
                                <div class="header-logo">
                                    <a href="<?= URL::base() . 'NewHome' ?>"><img class="logo-white" src="<?= URL::base(). $logo?>" alt="logo"></a>
                                    <a href="<?= URL::base() . 'NewHome' ?>"><img class="logo-black" src="<?= URL::base() . $logo ?>" alt="logo"></a>
                                </div>
                            </div>
                            <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-9">
                                <div class="header-main-right d-flex justify-content-end">
                                    <div class="main-menu mr-30 ml-30">
                                        <nav id="mobile-menu">
                                            ...
                                            <ul>
                                                ...
                                                <li class="<?php if ($Menus_Level2_Count > 0) { ?>menu-item-has-children<?php } ?>">
                                                    <a class="<?php if ($Menus_Level2_Count > 0) { ?>dropdown-toggle<?php } ?>" <?php if ($level1->target == 2) { ?>target="_blank"<?php } ?> href="<?php echo empty($level1->new_link) ? '#' : ($level1->internal_link == 1) ? URL::base() . $level1->new_link : $level1->new_link; ?>">
                                                    ...
                                                    <?php foreach ($Menus_Level2 as $Menus_Level2_value) { ?>
                                                        ...
                                                        <li <?php if ($Menus_Level3_Count > 0 || $Menus_Level2_value->id == 54) { ?>class="menu-item-has-children"<?php } ?>>
                                                            <a <?php if ($Menus_Level2_value->target == 2) { ?>target="_blank"<?php } ?> href="<?php echo empty($Menus_Level2_value->new_link) ? '#' : ($Menus_Level2_value->internal_link == 1) ? URL::base() . $Menus_Level2_value->new_link : $Menus_Level2_value->new_link; ?>">
                                    ...
                                    <div class="header-btn">
                                        <div class="cart-wrapper mr-10 ml-10">
                                        ...
                                        <div class="cart-wrapper mr-10 ml-10 user-profile">
                                                ...
                                                <div class="header__cart-icon p-relative">
                                                    <? if (empty($user_online)){ ?>
                                                        <a class="user-btn-sign-in" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#SignInModal">
                                                            <i style="color:#fff" class="fa fa-user-circle fa-lg" aria-hidden="true"></i><span><img style="background:#ec2424" class="item-number" src="<?php echo URL::base() . 'assets/new_theme/assets/img/shape/shape-light.png'; ?>"></span>
                                                        </a>
                                                    <?}else {?>
                                                        <i style="color:#fff" class="fa fa-user-circle fa-lg" aria-hidden="true"></i><span><img class="item-number" src="<?php echo URL::base() . 'assets/new_theme/assets/img/shape/shape-light.png'; ?>"></span>
                                                    <?}?>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="cart-wrapper mr-20 ml-10 user-profile">
                                            <a href="javascript:void(0);" class="notification-toggle-btn">
                                                <div class="header__cart-icon p-relative">
                                                    <? if (empty($user_online)){ ?>
                                                        <a class="user-btn-sign-in" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#SignInModal">
                                                            <i style="color:#fff" class="fa fa-bell fa-lg" aria-hidden="true"></i><span class="item-number">3</span>
                                                        </a>
                                                    <?}else {?>
                                                        <i style="color:#fff" class="fa fa-bell fa-lg" aria-hidden="true"></i><span class="item-number">
                                                        3</span>
                                        ...
                                        <? if (empty($user_online)) { ?>
                                            <a class="edu-thard-btn d-none d-lg-block" href="#" data-bs-toggle="modal" data-bs-target="#SignInModal"><?= Lang::__('Enroll now')?></a>
                                        <?}else{?>
                                            <a class="edu-thard-btn d-none d-lg-block" href="<?php echo URL::base() . 'NewHome_Login/logout'; ?>"><?= Lang::__('Log_out')?></a>
                                        <?}?>
                                        <div class="menu-bar ml-20 mr-20">
    ...
    <main>
        <!-- hero-area-start -->
        <div class="hero-area-3 hero-height-3" data-background="<?= URL::base() .  ORM::factory('Variables', 123)->img?>">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 text-center">
                        <div class="hero-university-text">
                            <span><?= ORM::factory('Variables', 123)->{'value_'.$lang}?></span>
                            <h2><?= ORM::factory('Variables', 123)->{'text_'.$lang}?></h2>
                        </div>
                        <div class="university-btn">
                            <a class="edu-five-btn" href="<?= URL::base() . ORM::factory('Variables', 124)->value ?>"><?= ORM::factory('Variables', 124)->{'value_'.$lang}?></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="university-main-wraper d-flex align-items-center">
                            <div class="university-course-box">
                                <div class="university-card-text">
                                    <p><?= $first_part->{'value_'.$lang}?></p>
                                    
                                    <h3><?= $first_part->{'text_'.$lang}?>
                                        <span><?= $first_part->{'text_'.$lang}?></span>
                                    </h3>
                                    <a class="edu-six-btn" href="#"><?= $first_part_button->{'value_'.$lang}?></a>
                                </div>
                            </div>
                            <div class="university-card-wrapper">
                                ...
                                <div class="university-card-content">
                                    <h3><?= $part_1->{'value_'.$lang}?></h3>
                                    <p><?= $part_1->{'text_'.$lang}?></p>
                                </div>
                            </div>
                            <div class="university-card-wrapper">
                                <div class="university-card-icon">
                                ...
                                <div class="university-card-content">
                                    <h3><?= $part_2->{'value_'.$lang}?></h3>
                                    <p><?= $part_2->{'text_'.$lang}?></p>
                                </div>
                            </div>
                            <div class="university-card-wrapper">
                                <div class="university-card-icon">
                                ...
                                <div class="university-card-content">
                                    <h3><?= $part_3->{'value_'.$lang}?></h3>
                                    <p><?= $part_3->{'text_'.$lang}?></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <?if($second_part->value == 1){?>
            <?if($second_part_description->value == 1){  //display random center ?>
                <? $Random_School_logo = (empty($Random_School->file_path))? ORM::factory('Variables',1)->value : $Random_School->file_path;
                   $profile_banner = (empty($Random_School->profile_banner))? ORM::factory('Variables',1)->value : $Random_School->profile_banner;
                   $Created_date = new DateTime($Random_School->Created_date);
                   $Created_date = $Created_date->format('Y');
                ?>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4">
                                <div class="section-title mb-30">
                                    <h2><span class="down-mark-line-2"><?= $Random_School->{'name_'.$lang}?></span>
                                        </h2>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4">
                                <div class="message-profile-text">
                                    <span><?= $Random_School->{'desc_'.$lang}?>.
                                    </span>
                                    <p><?= $Random_School->address . " - " . $Random_School->Country->{'name_'.$lang} . " - " . $Random_School->City->{'name_'.$lang}?>.</p>
                                </div>
                                <div class="message-meta">
                                    <a href="#"><img width="70" height="70" src="<?= URL::base() . $profile_banner ?>"
                                            alt="meta-img"></a>
                                    <div class="message-meta-link">
                                        <a href="#">
                                            <h4><?= $Random_School->phone?></h4>
                                        </a>
                                        <p><?= $Random_School->email?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4">
                                <div class="message-sticker position-relative">
                                    <img width="380" height="321" src="<?= URL::base() . $Random_School_logo ?>" alt="img">
                                    <div class="etablist-price">
                                        <p><?= Lang::__('since')?> <span><?= $Created_date ?></span> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="university-message-area pt-110 pb-105">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-4 col-lg-4">
                                <div class="section-title mb-30">
                                    <h2><?= $second_part->{'value_'.$lang}?><span class="down-mark-line-2"><?= $second_part->{'text_'.$lang}?></span>
                                        <?= $second_part_description->{'value_'.$lang}?></h2>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4">
                                <div class="message-profile-text">
                                    <span><?= $second_part_description->{'text_'.$lang}?>.
                                    </span>
                                    <p><?= $second_part_middle_description->{'text_'.$lang}?>.</p>
                                </div>
                                <div class="message-meta">
                                    <a href="#"><img src="<?= URL::base() . $second_part_middle_description->img ?>"
                                            alt="meta-img"></a>
                                    <div class="message-meta-link">
                                        <a href="#">
                                            <h4><?= $second_part_middle_description->{'value_'.$lang}?></h4>
                                        </a>
                                        <p><?= $second_part_middle_description2->{'value_'.$lang}?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4">
                                <div class="message-sticker position-relative">
                                    <img src="<?= URL::base() . $second_part_middle_description2->img ?>" alt="img">
                                    <div class="etablist-price">
                                        <p><?= $second_part_flag->{'value_'.$lang}?> <span><?= $second_part_flag->{'text_'.$lang}?></span> <?= $second_part_flag2->{'value_'.$lang}?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="academic-courses-area p-relative pt-110 pb-120">
            <img class="academic-shape-2" src="<?= URL::base() ?>assets/new_theme/assets/img/shape/acadenic-shape-2.png" alt="shape">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-4">
                        <div class="section-title mb-50">
                            <h2><span class="down-mark-line-2"><?= Lang::__('new_courses')?>..</span></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <? foreach($Recent_Sections as $Recent_Section) {
                        $section_logo = ($Recent_Section->logo_path != NULL)? $Recent_Section->logo_path : $Recent_Section->Course->img; 
                        if($section_logo == NULL ){   
                            $section_logo = ($Recent_Section->College->file_path != NULL)?  $Recent_Section->College->file_path : ORM::factory('Variables', 1)->value;
                        }
                        $description = $Recent_Section->Descriptions->where('is_deleted','=',NULL)->find();
                        if($description->loaded() && $description->{'name_'.$lang} != NULL){
                            $name = $description->{'name_'.$lang};
                            $desc = $description->{'desc_'.$lang};
                        }else{
                            $name = ($Recent_Section->{'name_'.$lang} != NULL)? $Recent_Section->{'name_'.$lang} : $Recent_Section->Course->{'name_'.$lang};
                            $desc = ($Recent_Section->{'desc_'.$lang} != NULL)? $Recent_Section->{'desc_'.$lang} : $Recent_Section->College->{'name_'.$lang};;
                        }

                        $Application = $Recent_Section->Teacher->Employee_Information ;
                    ...
                    ?>
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="academic-box position-relative mb-30">
                                <img class="academic-shape" src="<?= URL::base() ?>assets/new_theme/assets/img/shape/acadenic-shape-1.png"
                                    alt="image not found">
                                <div class="academic-thumb">
                                    <img width="410" height="240" src="<?= URL::base() . $section_logo ?>" alt="image not found">
                                </div>
                                <div class="academic-content">
                                    <div class="academic-content-header">
                                        <a href="<?= URL::base() . 'NewHome_Sections/CourseDetails/' . $Recent_Section->id?>">
                                            <h3><?= $name ?></h3>
                                        </a>
                                    </div>
                                    <div class="academic-body">
                                        <div class="academic-tutor d-flex align-items-center">
                                            <img width="30" height="30" src="<?= URL::base() . $teacher_img?>" alt="image not found">
                                            <a href="<?= URL::base() . 'NewHome_Instructors_Profile/Page/' . $Recent_Section->teacher ?>"><?= $Recent_Section->Teacher->{'name_'.$lang}?></a>
                                        </div>
                                        <p><?= $desc ?></p>
                                    </div>
                                    <div class="academic-footer">
                                        <div class="coursee-clock">
                                            <i class="flaticon-wall-clock"></i><span>4 Years</span>
                                        </div>
                                        <div class="course-creadit">
                                            <i class="flaticon-menu-1"></i><span>8 Credit</span>
                                        </div>
                                        <a class="edo-course-sec-btn" href="<?= URL::base() . 'NewHome_Sections/CourseDetails/' . $Recent_Section->id?>"><?= Lang::__('get_now')?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 text-center">
                        <div class="academic-bottom-btn ">
                            <a class="edo-theme-btn mt-30" href="<?= URL::base() . 'NewHome_Sections'?>"><?= Lang::__('view_all_courses')?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--counter-area-start -->
        <div class="counter-area pt-75 pb-30" data-background="<?= URL::base() ?>assets/new_theme/assets/img/bg/university-counter.png">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="university-counter-wrapper text-center mb-40">
                            ...
                            <div class="university-couner-text">
                                <span class="counter"><?= $Total_Centers?></span>
                                <p><?= Lang::__('centers')?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="university-counter-wrapper text-center mb-40">
                            ...
                            <div class="university-couner-text">
                                <span class="counter"><?= $Total_Teachers?></span><span>+</span>
                                <p><?= Lang::__('teachers')?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="university-counter-wrapper text-center mb-40">
                            ...
                            <div class="university-couner-text">
                                <span class="counter"><?= $Total_Sections?></span>
                                <p><?= Lang::__('Study_Sections')?></p>
                            </div>
                        </div>
                    </div>
        ...
        <? if(count($Packages) > 0){?>
            <!-- campus-area-start -->
            <div class="swiper-container feedback-active">
                ...
                <div class="swiper-wrapper">
                    ...
                    <?foreach($Packages as $Package){
                        $images = explode(',', $Package["details"]->slider_imgs);?>
                                    ...
                                    <div class="campus-wrapper position-relative">
                                        <div class="campus-shape-sticker">
                                            <div class="shape-light">
                                                <img src="<?= URL::base() ?>assets/new_theme/assets/img/shape/shape-light.png" alt="image not found">
                                            </div>
                                        ...
                                        <div class="campus-shape-1">
                                            <img src="<?= URL::base() ?>assets/new_theme/assets/img/shape/campus-shape-2.png" alt="shape">
                                        </div>
                                        <div class="campus-shape-2">
                                            <img src="<?= URL::base() ?>assets/new_theme/assets/img/shape/student-shape-05.png" alt="shape">
                                        </div>
                                        <div class="row align-items-center">
                                            <div class="col-xl-5 col-lg-6">
                                                <div class="compus-content mb-30">
                                                    <div class="section-title mb-30">
                                                        <h2><span class="down-mark-line-2"><?= $Package["details"]->{'name_'.$lang} ?></span></h2>
                                                    </div>
                                                    <p><?= $Package["details"]->{'desc_'.$lang} ?></p>
                                                    <ul>
                                                        <?foreach($Package["sections"] as $Section){?>
                                                            <li><i class="far fa-check"></i><?= empty($Section->{'name_'.$lang})? $Section->Course->{'name_'.$lang} : $Section->{'name_'.$lang}?></li>
                                                        <?}?>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 offset-xl-1 col-lg-6">
                                                <div class="campus-img-wrapper position-relative">
                                                    <div class="campus-shape-3">
                                                        <img src="<?= URL::base() ?>assets/new_theme/assets/img/shape/campus-shape-1.png" alt="image not found">
                                                    </div>
                                                    <? $i = 1 ; 
                                                    foreach($images as $image){
                                                        if($image != ''){?>
                                                            <div class="campus-img-<?= $i?>">
                                                                <img  src="<?= URL::base() . $image ?>" alt="image not found">
                                                            </div>
                                                    <?}  $i++; }?>
                                                    <?if($i < 5){?>
                                                        <?for($j= $i; $j <= 5 ; $j++){?>
                                                            <div class="campus-img-<?= $j?>">
                                                                <img  src="<?= URL::base() . $Package["logo"] ?>" alt="image not found">
                                                            </div>
                                                        <?}?>
                                                    <?}?>
                                                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-3 text-center">
                        <div class="academic-bottom-btn ">
                            <a class="edo-theme-btn mb-30" href="<?= URL::base() . 'NewHome_Packages'?>"><?= Lang::__('view_all_packages')?></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="event-area pt-110 pb-90">
            <div class="event-shape-wrapper position-relative">
                <div class="event-shape">
                    <img src="<?= URL::base() ?>assets/new_theme/assets/img/shape/feedback-img.png" alt="image not found">
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-12">
                        <div class="section-title mb-45">
                            <h2><?= Lang::__('last')?> <span class="down-mark-line-2"><?= Lang::__('Events')?></span></h2>
                        </div>
                         <table id="tbl_last_event" class="table " style="width:100%">
                                            ...
                                            <div class="current-event-box mb-15">
                                                <div class="current-event-date d-flex position-relative">
                                                    <div class="event-date-wrapper">
                                                        <?//php if(date('d', strtotime($event->event_date)) ==12){?>
                                                        <?php if($event->event_date < date("Y-m-d")){?>
                                                            <span class="event-date-end"><?= date('d', strtotime($event->event_date));?></span>
                                                        <?php } elseif((date('Y-m-d', strtotime($event->event_date))) == date("Y-m-d")){?>
                                                            <span id="begining_event" class="event-date-end event-date"><?= Lang::__('today');?></span>
                                                            <div class="event-shape-light">
                                                                <img src="<?php echo URL::base()?>assets/new_theme/assets/img/shape/shape-light.png" alt="image not found">
                                                            </div>
                                                        <?php }else {?>
                                                            <span id="begining_event" class="event-date"><?= date('d', strtotime($event->event_date));?></span>
                                                        <?php }?>
                                                        <span class="event-month"><?= date('M y', strtotime($event->event_date));?></span>
                                                    </div>
                                                    <div class="event-tour">
                                                        <div class="event-box-text">
                                                            <h3><a href="<?php echo URL::base() . 'NewHome_Events/Details/' . $event->id; ?>"><?= $event->title ;?></a></h3>
                                                            <span><i class="fal fa-clock"></i><?= date('h:s A', strtotime($event->event_date));?></span>
                                                            <span><i class="flaticon-place"></i><?= $event->Createdby->{'name_'.$lang} ;?></span>
                                                        </div>
                                                        <a href="<?php echo URL::base() . 'NewHome_Events/Details/' . $event->id; ?>" class="event-arrow">
                                                            <i class="fal fa-arrow-<?=($lang == "ar" ? 'left' : 'right')?>"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-12">
                        <div class="feedback-wrapper">
                                ...
                                <div class="swiper-container feedback-active">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <? foreach($Teachers as $Teacher){ 
                                            if(isset($Teacher->Employee_Information) && ($Teacher->Employee_Information->img_path != NULL)){
                                                $teacher_img = $Teacher->Employee_Information->img_path;
                                            }else{
                                                $teacher_img = 'assets/site/images/default-user.png';
                                            }
                                            $openedSections = ORM::factory('Study_Sections')->where('teacher','=',$Teacher->id)->where('status','=',1)->where('is_deleted','=',NULL)->count_all();
                                            $teacher_students = ORM::factory('Students_Sections')->where('state','=',3)->where('students_sections.status','=',1)->where('students_sections.is_deleted','=',NULL)->with('Section')->where('Section.teacher','=',$Teacher->id)->count_all();  
                                            $teacher_rates = DB::select(array(DB::expr('SUM(`rate`)'), 'rate'))
                                                                ->from('user_rates')
                                                                ->where('user_id','=',$Teacher->id)
                                                                ->execute();
                                            $rate = $teacher_rates->get('rate');
                                            $total_teacher_rates = ORM::factory('Users_Rates')->where('user_id','=',$Teacher->id)->count_all() * 5;
                                            $average_rate = ($total_teacher_rates > 0)? ($rate / $total_teacher_rates) : "0";
                                        ?>
                                                    ...
                                                    <div class="feedback-items position-relative">
                                                        <div class="feedback-header">
                                                            <div class="feedback-img">
                                                                <img width="65" height="65" src="<?= URL::base(). $teacher_img?>"
                                                                    alt="image not found">
                                                            </div>
                                                            <div class="feedback-title">
                                                                <h4><?= $Teacher->{'name_' . $lang}?></h4>
                                                                <span><?= $Teacher->College->{'name_' . $lang}?></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="feedback-body">
                                                            <h3><?= Lang::__('Courses') . " : " . $openedSections ?></h3>
                                                            <p><?= $Teacher->Employee_Information->details;?></p>
                                                        </div>
                            ...
                            <div class="col-sm-12 col-md-5">
                                <div >
                                    <a class="edo-theme-btn" href="#">see all teachers</a>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12 text-center">
                        <div class="section-title mb-55">
                            <h2><span class="down-mark-line-2"><?= Lang::__('Centers')?></span></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <? foreach($Schools as $School) {
                        $school_logo = (empty($School->file_path))? ORM::factory('Variables',1)->value : $School->file_path;
                    ?>
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="blog-wrapper position-relative mb-30">
                                <div class="blog-thumb ">
                                    <a href="<?php echo URL::base().'NewHome_Centers/Details/' . $School->id; ?>"><img width="410" height="260" src="<?= URL::base(). $school_logo?>" alt="blog-img"></a>
                                </div>
                                <a href="<?php echo URL::base().'NewHome_Centers/Details/' . $School->id; ?>" class="blog-tag">
                                    <i class="fal fa-folder-open"></i>
                                    <?= $School->Category->{'name_'.$lang}?>
                                </a>
                                <div class="blog-content-wrapper">
                                    <div class="blog-meta">
                                        <div class="blog-date">
                                            <i class="flaticon-calendar"></i>
                                            <span><?= date('d M y', strtotime($School->Created_date));?></span>
                                        </div>
                                        <div class="blog-user">
                                            <i class="flaticon-avatar"></i>
                                            <span><?= $School->Country->{'name_'.$lang} . " - " . $School->City->{'name_'.$lang} ?></span>
                                        </div>
                                    </div>
                                    <div class="blog-content">
                                        <a href="<?php echo URL::base().'NewHome_Centers/Details/' . $School->id; ?>">
                                            <h3><?= $School->{'name_'.$lang}?></h3>
                                        </a>
                                        <a class="blog-btn" href="<?php echo URL::base().'NewHome_Centers/Details/' . $School->id; ?>"><?= Lang::__('read_more')?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-3 text-center">
                            <div class="academic-bottom-btn ">
                                <a class="edo-theme-btn mb-30" href="<?= URL::base() . 'NewHome_Centers'?>"><?= Lang::__('view_all_centers')?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="gallery-area">
            ...
            <div class="swiper-containers">
                ...
                <div class="swiper-wrappers gallery-inner">
                    <!-- Slides -->
                    <?if($footer->img != NULL && $footer->img != ""){
                        $footer_images = explode(",",$footer->img); 
                        foreach($footer_images as $value){
                            if($value != ''){
                    ?>
                                <div class="swiper-slides gallery-single w-img">
                                    <img width="384" height="431" src="<?= URL::base() . $value?>" alt="image not found">
                                        ...
                                        <div class="university-footer-widget-body">
                                            <div class="university-footer-link">
                                                <ul>
                                                    ...
                                                    ?>
                                                        <li>
                                                            <a <?php if ($value->target == 2) { ?>target="_blank"<?php } ?> href="<?php echo empty($value->new_link) ? '#' : ($value->internal_link == 1) ? URL::base() . $value->new_link : $value->new_link; ?>">
