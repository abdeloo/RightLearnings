...
var KTDatatablesServerSide = function () {
    ...
    var initDatatable = function () {
        ...
        dt = $("#kt_table_users").DataTable({
            ...
            ajax: {
                'url': URLBase + "NewVersion_Events/GetData",
                'type': "POST",
                "data": function ( d ) {
                    ...
                    render: function (data, type, row) {
                        ...
                        if(data != null){
                            ...
                            $.each(myArray, function(index, value) {
                                if(value != ""){
                                    sponsors += `<img src="${URLBase}${value}" class="w-35px me-3" alt="${value}">`;
                                }
                            });
                        }
        ...
        dt.on('click', '[data-details]', function() {
            ...
            //     console.log(key+ " *** " + val);
            // });  
            $("#kt_modal_section_app_form :input").map(function(index, elm) {
                
                if(elm.type != "file"){
                    if(elm.type == "select-one"){
                        console.log(elm.name);
                        $(elm).val(details[elm.name]).change();
                    }else{
                        elm.value = details[elm.name];
                    }
                }
                $('#img_path').attr("style", "background-image:url(" + URLBase + details["img_path"] + ")");
                $('#banner_path').attr("style", "background-image:url(" + URLBase + details["banner_path"] + ")");
    ...
    var resetForm = () => {
        ...
        $("#add_new_event").click(function(e) {
            $("#kt_modal_section_app_form")[0].reset()   ;          
            $("#teacher").val('').change();
            $("#currency").val('').change();
            $('#img_path').attr("style", "background-image:''");
            $('#banner_path').attr("style", "background-image:''");
        });
