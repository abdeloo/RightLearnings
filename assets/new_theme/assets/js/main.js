 ...
 ****************************************************/
 ...
 (function ($) {
    ...
    //NiceSelect.bind(document.getElementsByClassName(".nice_select"));

    $(".nice-select2").each(function () {
        var selector = $(this).attr('id');
        console.log($(this).closest('.signup-wrapper').find('.nice-select-search').val);
        if ($(this).is('[searchable]')) {

            var instance = NiceSelect.bind(document.getElementById(selector), {
                searchable: true,
                placeholder: 'اختر ',
                searchtext: 'zoek',
            ...
            var instance = NiceSelect.bind(document.getElementById(selector), {placeholder: 'اختر '});
            instance.update();
        }
    ...
    ////////////////////////////////////////////////////
    // 33. profile Toggle Js
    $(".profile-toggle-btn").on("click", function () {
        $(".profilemini__wrapper").addClass("opened");
        $(".body-overlay").addClass("opened");
    });
    $(".profilemini__close-btn").on("click", function () {
        $(".profilemini__wrapper").removeClass("opened");
        $(".body-overlay").removeClass("opened");
    });
    $(".body-overlay").on("click", function () {
        $(".profilemini__wrapper").removeClass("opened");
    ...
    $('#country-flag option').each(function () {
        ...
        if (typeof $(this).attr('selected') != "undefined") {
            ...
            $('div.country span.current').html(selectedText);
        }
        langArray.push(item);
    })

    $('div.country .list').html(langArray);
...
//check local storage for the lang
    ...
    $('#Show_SignInModel').on('click', function() {
        $(".side-info").removeClass("info-open");
        $(".offcanvas-overlay").removeClass("overlay-open");
